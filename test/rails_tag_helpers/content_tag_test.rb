...
class ContentTagTest < ActionView::TestCase
  context 'basic options' do
    ...
    should 'render the tag with specified content and options' do
      assert_dom_equal %(<div class="flex">content</div>), content_tag(:div, 'content', **subject)
    end

    should 'render the tag with specified block content and options' do
      assert_dom_equal %(<div class="flex">content</div>), content_tag(:div, **subject) { 'content' }
    end
  end
  ...
  context 'nested options' do
    ...
    should 'render the tag with specified content and options' do
      assert_dom_equal(
        ...
        content_tag(:div, **subject) { 'content' }
      )
    end
  end
end
